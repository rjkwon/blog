...
export declare namespace appengine_v1 {
    ...
    export class Resource$Apps {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        listRuntimes(params: Params$Resource$Apps$Listruntimes, options: StreamMethodOptions): GaxiosPromise<Readable>;
        listRuntimes(params?: Params$Resource$Apps$Listruntimes, options?: MethodOptions): GaxiosPromise<Schema$ListRuntimesResponse>;
    ...
    export class Resource$Projects$Locations$Applications$Services {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Applications$Services$Delete, options: StreamMethodOptions): GaxiosPromise<Readable>;
        delete(params?: Params$Resource$Projects$Locations$Applications$Services$Delete, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
    ...
    export class Resource$Projects$Locations$Applications$Services$Versions {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Applications$Services$Versions$Delete, options: StreamMethodOptions): GaxiosPromise<Readable>;
        delete(params?: Params$Resource$Projects$Locations$Applications$Services$Versions$Delete, options?: MethodOptions): GaxiosPromise<Schema$Operation>;

...
export declare namespace firestore_v1 {
    ...
    export class Resource$Projects$Databases {
         ...
         */
        bulkDeleteDocuments(params: Params$Resource$Projects$Databases$Bulkdeletedocuments, options: StreamMethodOptions): GaxiosPromise<Readable>;
        bulkDeleteDocuments(params?: Params$Resource$Projects$Databases$Bulkdeletedocuments, options?: MethodOptions): GaxiosPromise<Schema$GoogleLongrunningOperation>;

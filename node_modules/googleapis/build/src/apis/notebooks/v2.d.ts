...
export declare namespace notebooks_v2 {
    ...
    export class Resource$Projects$Locations$Instances {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getConfig(params: Params$Resource$Projects$Locations$Instances$Getconfig, options: StreamMethodOptions): GaxiosPromise<Readable>;
        getConfig(params?: Params$Resource$Projects$Locations$Instances$Getconfig, options?: MethodOptions): GaxiosPromise<Schema$Config>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        resizeDisk(params: Params$Resource$Projects$Locations$Instances$Resizedisk, options: StreamMethodOptions): GaxiosPromise<Readable>;
        resizeDisk(params?: Params$Resource$Projects$Locations$Instances$Resizedisk, options?: MethodOptions): GaxiosPromise<Schema$Operation>;

...
export declare namespace recaptchaenterprise_v1 {
    ...
    export class Resource$Projects$Firewallpolicies {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        reorder(params: Params$Resource$Projects$Firewallpolicies$Reorder, options: StreamMethodOptions): GaxiosPromise<Readable>;
        reorder(params?: Params$Resource$Projects$Firewallpolicies$Reorder, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRecaptchaenterpriseV1ReorderFirewallPoliciesResponse>;
    ...
    export class Resource$Projects$Keys {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        addIpOverride(params: Params$Resource$Projects$Keys$Addipoverride, options: StreamMethodOptions): GaxiosPromise<Readable>;
        addIpOverride(params?: Params$Resource$Projects$Keys$Addipoverride, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRecaptchaenterpriseV1AddIpOverrideResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        listIpOverrides(params: Params$Resource$Projects$Keys$Listipoverrides, options: StreamMethodOptions): GaxiosPromise<Readable>;
        listIpOverrides(params?: Params$Resource$Projects$Keys$Listipoverrides, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRecaptchaenterpriseV1ListIpOverridesResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        removeIpOverride(params: Params$Resource$Projects$Keys$Removeipoverride, options: StreamMethodOptions): GaxiosPromise<Readable>;
        removeIpOverride(params?: Params$Resource$Projects$Keys$Removeipoverride, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRecaptchaenterpriseV1RemoveIpOverrideResponse>;

...
export declare namespace gkeonprem_v1 {
    ...
    export class Resource$Projects$Locations$Vmwareadminclusters {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Vmwareadminclusters$Create, options: StreamMethodOptions): GaxiosPromise<Readable>;
        create(params?: Params$Resource$Projects$Locations$Vmwareadminclusters$Create, options?: MethodOptions): GaxiosPromise<Schema$Operation>;

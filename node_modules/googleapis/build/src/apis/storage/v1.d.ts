...
export declare namespace storage_v1 {
    ...
    export class Resource$Buckets {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getStorageLayout(params: Params$Resource$Buckets$Getstoragelayout, options: StreamMethodOptions): GaxiosPromise<Readable>;
        getStorageLayout(params?: Params$Resource$Buckets$Getstoragelayout, options?: MethodOptions): GaxiosPromise<Schema$BucketStorageLayout>;

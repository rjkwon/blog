...
export declare namespace binaryauthorization_v1 {
    ...
    export class Resource$Projects$Platforms$Gke$Policies {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        evaluate(params: Params$Resource$Projects$Platforms$Gke$Policies$Evaluate, options: StreamMethodOptions): GaxiosPromise<Readable>;
        evaluate(params?: Params$Resource$Projects$Platforms$Gke$Policies$Evaluate, options?: MethodOptions): GaxiosPromise<Schema$EvaluateGkePolicyResponse>;

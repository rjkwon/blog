...
export declare namespace places_v1 {
    ...
    export class Resource$Places {
         ...
         */
        autocomplete(params: Params$Resource$Places$Autocomplete, options: StreamMethodOptions): GaxiosPromise<Readable>;
        autocomplete(params?: Params$Resource$Places$Autocomplete, options?: MethodOptions): GaxiosPromise<Schema$GoogleMapsPlacesV1AutocompletePlacesResponse>;

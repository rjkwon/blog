...
export declare namespace solar_v1 {
    ...
    export class Resource$Buildinginsights {
         ...
         */
        findClosest(params: Params$Resource$Buildinginsights$Findclosest, options: StreamMethodOptions): GaxiosPromise<Readable>;
        findClosest(params?: Params$Resource$Buildinginsights$Findclosest, options?: MethodOptions): GaxiosPromise<Schema$BuildingInsights>;
    ...
    export class Resource$Datalayers {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Datalayers$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Datalayers$Get, options?: MethodOptions): GaxiosPromise<Schema$DataLayers>;
    ...
    export class Resource$Geotiff {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Geotiff$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Geotiff$Get, options?: MethodOptions): GaxiosPromise<Schema$HttpBody>;

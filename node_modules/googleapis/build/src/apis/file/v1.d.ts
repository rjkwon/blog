...
export declare namespace file_v1 {
    ...
    export class Resource$Projects$Locations$Instances {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        promoteReplica(params: Params$Resource$Projects$Locations$Instances$Promotereplica, options: StreamMethodOptions): GaxiosPromise<Readable>;
        promoteReplica(params?: Params$Resource$Projects$Locations$Instances$Promotereplica, options?: MethodOptions): GaxiosPromise<Schema$Operation>;

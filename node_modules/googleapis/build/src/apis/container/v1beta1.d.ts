...
export declare namespace container_v1beta1 {
    ...
    export class Resource$Projects$Locations$Clusters {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        fetchClusterUpgradeInfo(params: Params$Resource$Projects$Locations$Clusters$Fetchclusterupgradeinfo, options: StreamMethodOptions): GaxiosPromise<Readable>;
        fetchClusterUpgradeInfo(params?: Params$Resource$Projects$Locations$Clusters$Fetchclusterupgradeinfo, options?: MethodOptions): GaxiosPromise<Schema$ClusterUpgradeInfo>;
    ...
    export class Resource$Projects$Locations$Clusters$Nodepools {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        fetchNodePoolUpgradeInfo(params: Params$Resource$Projects$Locations$Clusters$Nodepools$Fetchnodepoolupgradeinfo, options: StreamMethodOptions): GaxiosPromise<Readable>;
        fetchNodePoolUpgradeInfo(params?: Params$Resource$Projects$Locations$Clusters$Nodepools$Fetchnodepoolupgradeinfo, options?: MethodOptions): GaxiosPromise<Schema$NodePoolUpgradeInfo>;
    ...
    export class Resource$Projects$Zones$Clusters {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        fetchClusterUpgradeInfo(params: Params$Resource$Projects$Zones$Clusters$Fetchclusterupgradeinfo, options: StreamMethodOptions): GaxiosPromise<Readable>;
        fetchClusterUpgradeInfo(params?: Params$Resource$Projects$Zones$Clusters$Fetchclusterupgradeinfo, options?: MethodOptions): GaxiosPromise<Schema$ClusterUpgradeInfo>;
    ...
    export class Resource$Projects$Zones$Clusters$Nodepools {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        fetchNodePoolUpgradeInfo(params: Params$Resource$Projects$Zones$Clusters$Nodepools$Fetchnodepoolupgradeinfo, options: StreamMethodOptions): GaxiosPromise<Readable>;
        fetchNodePoolUpgradeInfo(params?: Params$Resource$Projects$Zones$Clusters$Nodepools$Fetchnodepoolupgradeinfo, options?: MethodOptions): GaxiosPromise<Schema$NodePoolUpgradeInfo>;

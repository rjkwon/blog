...
export declare namespace documentai_v1beta3 {
    ...
    export class Resource$Projects$Locations$Processors$Dataset {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        listDocuments(params: Params$Resource$Projects$Locations$Processors$Dataset$Listdocuments, options: StreamMethodOptions): GaxiosPromise<Readable>;
        listDocuments(params?: Params$Resource$Projects$Locations$Processors$Dataset$Listdocuments, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDocumentaiV1beta3ListDocumentsResponse>;

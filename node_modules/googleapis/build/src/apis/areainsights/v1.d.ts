...
export declare namespace areainsights_v1 {
    ...
    export class Resource$V1 {
         ...
         */
        computeInsights(params: Params$Resource$V1$Computeinsights, options: StreamMethodOptions): GaxiosPromise<Readable>;
        computeInsights(params?: Params$Resource$V1$Computeinsights, options?: MethodOptions): GaxiosPromise<Schema$ComputeInsightsResponse>;

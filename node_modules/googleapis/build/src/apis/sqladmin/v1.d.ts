...
export declare namespace sqladmin_v1 {
    ...
    export class Resource$Instances {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        acquireSsrsLease(params: Params$Resource$Instances$Acquiressrslease, options: StreamMethodOptions): GaxiosPromise<Readable>;
        acquireSsrsLease(params?: Params$Resource$Instances$Acquiressrslease, options?: MethodOptions): GaxiosPromise<Schema$SqlInstancesAcquireSsrsLeaseResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        addServerCertificate(params: Params$Resource$Instances$Addservercertificate, options: StreamMethodOptions): GaxiosPromise<Readable>;
        addServerCertificate(params?: Params$Resource$Instances$Addservercertificate, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        demote(params: Params$Resource$Instances$Demote, options: StreamMethodOptions): GaxiosPromise<Readable>;
        demote(params?: Params$Resource$Instances$Demote, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        ListServerCertificates(params: Params$Resource$Instances$Listservercertificates, options: StreamMethodOptions): GaxiosPromise<Readable>;
        ListServerCertificates(params?: Params$Resource$Instances$Listservercertificates, options?: MethodOptions): GaxiosPromise<Schema$InstancesListServerCertificatesResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        releaseSsrsLease(params: Params$Resource$Instances$Releasessrslease, options: StreamMethodOptions): GaxiosPromise<Readable>;
        releaseSsrsLease(params?: Params$Resource$Instances$Releasessrslease, options?: MethodOptions): GaxiosPromise<Schema$SqlInstancesReleaseSsrsLeaseResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        RotateServerCertificate(params: Params$Resource$Instances$Rotateservercertificate, options: StreamMethodOptions): GaxiosPromise<Readable>;
        RotateServerCertificate(params?: Params$Resource$Instances$Rotateservercertificate, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        switchover(params: Params$Resource$Instances$Switchover, options: StreamMethodOptions): GaxiosPromise<Readable>;
        switchover(params?: Params$Resource$Instances$Switchover, options?: MethodOptions): GaxiosPromise<Schema$Operation>;

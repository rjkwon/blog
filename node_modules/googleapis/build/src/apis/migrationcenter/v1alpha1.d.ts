...
export declare namespace migrationcenter_v1alpha1 {
    ...
    export class Resource$Projects$Locations$Relations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Relations$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Projects$Locations$Relations$Get, options?: MethodOptions): GaxiosPromise<Schema$Relation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Relations$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Projects$Locations$Relations$List, options?: MethodOptions): GaxiosPromise<Schema$ListRelationsResponse>;

...
export declare namespace chromemanagement_v1 {
    ...
    export class Resource$Customers$Profiles {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Customers$Profiles$Delete, options: StreamMethodOptions): GaxiosPromise<Readable>;
        delete(params?: Params$Resource$Customers$Profiles$Delete, options?: MethodOptions): GaxiosPromise<Schema$GoogleProtobufEmpty>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Customers$Profiles$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Customers$Profiles$Get, options?: MethodOptions): GaxiosPromise<Schema$GoogleChromeManagementVersionsV1ChromeBrowserProfile>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Customers$Profiles$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Customers$Profiles$List, options?: MethodOptions): GaxiosPromise<Schema$GoogleChromeManagementVersionsV1ListChromeBrowserProfilesResponse>;

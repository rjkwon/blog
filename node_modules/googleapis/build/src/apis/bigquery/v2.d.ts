...
export declare namespace bigquery_v2 {
    ...
    export class Resource$Datasets {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        undelete(params: Params$Resource$Datasets$Undelete, options: StreamMethodOptions): GaxiosPromise<Readable>;
        undelete(params?: Params$Resource$Datasets$Undelete, options?: MethodOptions): GaxiosPromise<Schema$Dataset>;
    ...
    export class Resource$Routines {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getIamPolicy(params: Params$Resource$Routines$Getiampolicy, options: StreamMethodOptions): GaxiosPromise<Readable>;
        getIamPolicy(params?: Params$Resource$Routines$Getiampolicy, options?: MethodOptions): GaxiosPromise<Schema$Policy>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        setIamPolicy(params: Params$Resource$Routines$Setiampolicy, options: StreamMethodOptions): GaxiosPromise<Readable>;
        setIamPolicy(params?: Params$Resource$Routines$Setiampolicy, options?: MethodOptions): GaxiosPromise<Schema$Policy>;

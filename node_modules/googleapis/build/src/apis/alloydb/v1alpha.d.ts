...
export declare namespace alloydb_v1alpha {
    ...
    export class Resource$Projects$Locations$Clusters {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        export(params: Params$Resource$Projects$Locations$Clusters$Export, options: StreamMethodOptions): GaxiosPromise<Readable>;
        export(params?: Params$Resource$Projects$Locations$Clusters$Export, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        restoreFromCloudSQL(params: Params$Resource$Projects$Locations$Clusters$Restorefromcloudsql, options: StreamMethodOptions): GaxiosPromise<Readable>;
        restoreFromCloudSQL(params?: Params$Resource$Projects$Locations$Clusters$Restorefromcloudsql, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        switchover(params: Params$Resource$Projects$Locations$Clusters$Switchover, options: StreamMethodOptions): GaxiosPromise<Readable>;
        switchover(params?: Params$Resource$Projects$Locations$Clusters$Switchover, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        upgrade(params: Params$Resource$Projects$Locations$Clusters$Upgrade, options: StreamMethodOptions): GaxiosPromise<Readable>;
        upgrade(params?: Params$Resource$Projects$Locations$Clusters$Upgrade, options?: MethodOptions): GaxiosPromise<Schema$Operation>;

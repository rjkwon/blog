...
export declare namespace workspaceevents_v1 {
    ...
    export class Resource$Subscriptions {
        ...
        create(params?: Params$Resource$Subscriptions$Create, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
        ...
        delete(params?: Params$Resource$Subscriptions$Delete, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Subscriptions$Patch, options: StreamMethodOptions): GaxiosPromise<Readable>;
        patch(params?: Params$Resource$Subscriptions$Patch, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        reactivate(params: Params$Resource$Subscriptions$Reactivate, options: StreamMethodOptions): GaxiosPromise<Readable>;
        reactivate(params?: Params$Resource$Subscriptions$Reactivate, options?: MethodOptions): GaxiosPromise<Schema$Operation>;

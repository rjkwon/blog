...
export declare namespace serviceconsumermanagement_v1beta1 {
    ...
    export class Resource$Services$Consumerquotametrics {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        importProducerQuotaPolicies(params: Params$Resource$Services$Consumerquotametrics$Importproducerquotapolicies, options: StreamMethodOptions): GaxiosPromise<Readable>;
        importProducerQuotaPolicies(params?: Params$Resource$Services$Consumerquotametrics$Importproducerquotapolicies, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
    ...
    export class Resource$Services$Consumerquotametrics$Limits$Producerquotapolicies {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Services$Consumerquotametrics$Limits$Producerquotapolicies$Create, options: StreamMethodOptions): GaxiosPromise<Readable>;
        create(params?: Params$Resource$Services$Consumerquotametrics$Limits$Producerquotapolicies$Create, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Services$Consumerquotametrics$Limits$Producerquotapolicies$Delete, options: StreamMethodOptions): GaxiosPromise<Readable>;
        delete(params?: Params$Resource$Services$Consumerquotametrics$Limits$Producerquotapolicies$Delete, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Services$Consumerquotametrics$Limits$Producerquotapolicies$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Services$Consumerquotametrics$Limits$Producerquotapolicies$List, options?: MethodOptions): GaxiosPromise<Schema$V1Beta1ListProducerQuotaPoliciesResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Services$Consumerquotametrics$Limits$Producerquotapolicies$Patch, options: StreamMethodOptions): GaxiosPromise<Readable>;
        patch(params?: Params$Resource$Services$Consumerquotametrics$Limits$Producerquotapolicies$Patch, options?: MethodOptions): GaxiosPromise<Schema$Operation>;

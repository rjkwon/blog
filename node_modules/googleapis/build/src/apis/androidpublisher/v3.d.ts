...
export declare namespace androidpublisher_v3 {
    ...
    export class Resource$Apprecovery {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Apprecovery$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Apprecovery$List, options?: MethodOptions): GaxiosPromise<Schema$ListAppRecoveriesResponse>;

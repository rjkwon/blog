...
export declare namespace datacatalog_v1 {
    ...
    export class Resource$Organizations$Locations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        retrieveConfig(params: Params$Resource$Organizations$Locations$Retrieveconfig, options: StreamMethodOptions): GaxiosPromise<Readable>;
        retrieveConfig(params?: Params$Resource$Organizations$Locations$Retrieveconfig, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDatacatalogV1OrganizationConfig>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        retrieveEffectiveConfig(params: Params$Resource$Organizations$Locations$Retrieveeffectiveconfig, options: StreamMethodOptions): GaxiosPromise<Readable>;
        retrieveEffectiveConfig(params?: Params$Resource$Organizations$Locations$Retrieveeffectiveconfig, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDatacatalogV1MigrationConfig>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        setConfig(params: Params$Resource$Organizations$Locations$Setconfig, options: StreamMethodOptions): GaxiosPromise<Readable>;
        setConfig(params?: Params$Resource$Organizations$Locations$Setconfig, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDatacatalogV1MigrationConfig>;
    ...
    export class Resource$Projects$Locations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        retrieveEffectiveConfig(params: Params$Resource$Projects$Locations$Retrieveeffectiveconfig, options: StreamMethodOptions): GaxiosPromise<Readable>;
        retrieveEffectiveConfig(params?: Params$Resource$Projects$Locations$Retrieveeffectiveconfig, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDatacatalogV1MigrationConfig>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        setConfig(params: Params$Resource$Projects$Locations$Setconfig, options: StreamMethodOptions): GaxiosPromise<Readable>;
        setConfig(params?: Params$Resource$Projects$Locations$Setconfig, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDatacatalogV1MigrationConfig>;

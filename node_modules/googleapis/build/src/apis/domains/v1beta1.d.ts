...
export declare namespace domains_v1beta1 {
    ...
    export class Resource$Projects$Locations$Registrations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        initiatePushTransfer(params: Params$Resource$Projects$Locations$Registrations$Initiatepushtransfer, options: StreamMethodOptions): GaxiosPromise<Readable>;
        initiatePushTransfer(params?: Params$Resource$Projects$Locations$Registrations$Initiatepushtransfer, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        renewDomain(params: Params$Resource$Projects$Locations$Registrations$Renewdomain, options: StreamMethodOptions): GaxiosPromise<Readable>;
        renewDomain(params?: Params$Resource$Projects$Locations$Registrations$Renewdomain, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        retrieveGoogleDomainsDnsRecords(params: Params$Resource$Projects$Locations$Registrations$Retrievegoogledomainsdnsrecords, options: StreamMethodOptions): GaxiosPromise<Readable>;
        retrieveGoogleDomainsDnsRecords(params?: Params$Resource$Projects$Locations$Registrations$Retrievegoogledomainsdnsrecords, options?: MethodOptions): GaxiosPromise<Schema$RetrieveGoogleDomainsDnsRecordsResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        retrieveGoogleDomainsForwardingConfig(params: Params$Resource$Projects$Locations$Registrations$Retrievegoogledomainsforwardingconfig, options: StreamMethodOptions): GaxiosPromise<Readable>;
        retrieveGoogleDomainsForwardingConfig(params?: Params$Resource$Projects$Locations$Registrations$Retrievegoogledomainsforwardingconfig, options?: MethodOptions): GaxiosPromise<Schema$RetrieveGoogleDomainsForwardingConfigResponse>;

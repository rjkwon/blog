...
export declare namespace connectors_v2 {
    ...
    export class Resource$Projects$Locations$Connections {
         ...
         */
        checkReadiness(params: Params$Resource$Projects$Locations$Connections$Checkreadiness, options: StreamMethodOptions): GaxiosPromise<Readable>;
        checkReadiness(params?: Params$Resource$Projects$Locations$Connections$Checkreadiness, options?: MethodOptions): GaxiosPromise<Schema$CheckReadinessResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        checkStatus(params: Params$Resource$Projects$Locations$Connections$Checkstatus, options: StreamMethodOptions): GaxiosPromise<Readable>;
        checkStatus(params?: Params$Resource$Projects$Locations$Connections$Checkstatus, options?: MethodOptions): GaxiosPromise<Schema$CheckStatusResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        exchangeAuthCode(params: Params$Resource$Projects$Locations$Connections$Exchangeauthcode, options: StreamMethodOptions): GaxiosPromise<Readable>;
        exchangeAuthCode(params?: Params$Resource$Projects$Locations$Connections$Exchangeauthcode, options?: MethodOptions): GaxiosPromise<Schema$ExchangeAuthCodeResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        refreshAccessToken(params: Params$Resource$Projects$Locations$Connections$Refreshaccesstoken, options: StreamMethodOptions): GaxiosPromise<Readable>;
        refreshAccessToken(params?: Params$Resource$Projects$Locations$Connections$Refreshaccesstoken, options?: MethodOptions): GaxiosPromise<Schema$RefreshAccessTokenResponse>;

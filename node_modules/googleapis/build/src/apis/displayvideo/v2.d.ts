...
export declare namespace displayvideo_v2 {
    ...
    export class Resource$Floodlightgroups$Floodlightactivities {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Floodlightgroups$Floodlightactivities$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Floodlightgroups$Floodlightactivities$Get, options?: MethodOptions): GaxiosPromise<Schema$FloodlightActivity>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Floodlightgroups$Floodlightactivities$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Floodlightgroups$Floodlightactivities$List, options?: MethodOptions): GaxiosPromise<Schema$ListFloodlightActivitiesResponse>;

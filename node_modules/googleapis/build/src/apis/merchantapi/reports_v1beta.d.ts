...
export declare namespace merchantapi_reports_v1beta {
    ...
    export class Resource$Accounts$Reports {
         ...
         */
        search(params: Params$Resource$Accounts$Reports$Search, options: StreamMethodOptions): GaxiosPromise<Readable>;
        search(params?: Params$Resource$Accounts$Reports$Search, options?: MethodOptions): GaxiosPromise<Schema$SearchResponse>;

...
export declare namespace bigqueryreservation_v1 {
    ...
    export class Resource$Projects$Locations$Reservations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        failoverReservation(params: Params$Resource$Projects$Locations$Reservations$Failoverreservation, options: StreamMethodOptions): GaxiosPromise<Readable>;
        failoverReservation(params?: Params$Resource$Projects$Locations$Reservations$Failoverreservation, options?: MethodOptions): GaxiosPromise<Schema$Reservation>;

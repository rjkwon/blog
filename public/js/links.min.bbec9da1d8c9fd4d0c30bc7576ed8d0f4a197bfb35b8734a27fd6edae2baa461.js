document.addEventListener("DOMContentLoaded",function(){const e="https://script.google.com/macros/s/AKfycbzjyQRiPiz2ejXyBD-68th_q-Mqe-oVQ4925VHfKsCCv7ROimh3fmNVbPujCF0F9nn0/exec?key=x5DA7Gxf8FnCFnDe";fetch(e).then(e=>{if(!e.ok)throw new Error(`HTTP error! Status: ${e.status}`);return e.json()}).then(e=>{const t=document.getElementById("linkroll");t.innerHTML="";const n=e.sort((e,t)=>new Date(t.dateAdded)-new Date(e.dateAdded)),s=n.slice(0,9);s.forEach(e=>{const n=document.createElement("div");n.innerHTML=`
